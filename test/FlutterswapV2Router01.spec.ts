...
enum RouterVersion {
  FlutterswapRouter01 = 'FlutterswapRouter01',
  FlutterswapRouter02 = 'FlutterswapRouter02'
}

describe('FlutterswapRouter{01,02}', () => {
  for (const routerVersion of Object.keys(RouterVersion)) {
    ...
    beforeEach(async function() {
      ...
      router = {
        [RouterVersion.FlutterswapRouter01]: fixture.router01,
        [RouterVersion.FlutterswapRouter02]: fixture.router02
    ...
    describe(routerVersion, () => {
      ...
      describe('swapExactTokensForTokens', () => {
        ...
        it('gas', async () => {
          ...
          expect(receipt.gasUsed).to.eq(
            {
              [RouterVersion.FlutterswapRouter01]: 101876,
              [RouterVersion.FlutterswapRouter02]: 101898
            }[routerVersion as RouterVersion]
          )
        }).retries(3)
      })
      ...
      describe('swapExactETHForTokens', () => {
        ...
        it('gas', async () => {
          ...
          expect(receipt.gasUsed).to.eq(
            {
              [RouterVersion.FlutterswapRouter01]: 138770,
              [RouterVersion.FlutterswapRouter02]: 138770
            }[routerVersion as RouterVersion]
          )
        }).retries(3)
      })
